...
public class ImpAddressBook implements AddressBookUtil {
	Scanner scanner = new Scanner(System.in);
	int counter = 0;
	String path = "/home/admin94/Desktop/FellowshipPrograms/OOPs/addressbook2.json";
	String statename = "";
...
//				}
//			}
			Collections.sort(persons, (e1, e2) -> e1.getLastName().compareTo(e2.getFirstName()));
